...
You can copy this file to a CSV file 'metadata/station/station_list.csv' in your $WIS2BOX_HOST_DATADIR :
...
And edit 'metadata/station/station_list.csv' to contain the data for your stations.
