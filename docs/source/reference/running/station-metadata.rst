...
Then login in to the wis2box-container and run the command ``wis2box metadata station publish-collection --path /data/wis2box/metadata/station/station_list.csv`` --topic-hierarchy <topic-hierarchy>
