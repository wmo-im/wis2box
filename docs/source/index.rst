...
WMO INFORMATION SYSTEM (WIS) 2.0 IN A BOX was started in November 2021 to provide a system to share data using the `WIS2 framework <https://community.wmo.int/activity-areas/wis>`_.
